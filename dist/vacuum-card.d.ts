...
export declare class VacuumCard extends LitElement {
    hass: HomeAssistant;
...
export declare class VacuumCardEditor extends LitElement {
    hass: HomeAssistant;
...
//# sourceMappingURL=vacuum-card.d.ts.map